...
<head>
    ...
    <title>Mobile Phones | Trewo Tech</title>
                            ...
                            <div class="offset-0 col-12 text-center">
                                <div class="row justify-content-center gap-3 ">
                                    ...
                                    <div class="col-12 mt-3 mb-2">
                                        <a class="text-decoration-none link-dark fs-3 fw-bold">Mobile Phones</a> &nbsp;&nbsp;
                                    </div>
                                    <!-- category name -->
                                    <!-- product -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 ">
                                                <div class="row justify-content-center gap-4 mx-3">
                                                    ...
                                                    $product_rs = Database::search("SELECT * FROM `product` WHERE `category_id`='1' AND `status_id`='1' ORDER BY `datetime_added` DESC ");
